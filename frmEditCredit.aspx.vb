...
Partial Class Modules_Manager_Manage_Case_frmEditCredit
    Inherits System.Web.UI.Page
    Dim ISODate As New ISODate
    Public strLinkCredit As String
    ...
    Protected Sub GVShow_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GVShow.RowCommand
        If e.CommandName = "select" Then
            strLinkCredit = "frmEditCreditDetail.aspx?AppID=" & GVShow.DataKeys(e.CommandArgument).Item(0)
        End If
