<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Page/Index/MasterPage.master" AutoEventWireup="false" CodeFile="frmSummaryReport.aspx.vb" Inherits="Modules_Manager_Report_frmAgentCall" %>
...
<font style="color: #0099FF; font-weight: bold; font-size: 18px">Sale</font>
<font style="color: Black ; font-weight: bold; font-size: 18px">Report</font>
    ...
    <div style="border-top: 2px solid #66CCFF; text-align: center;">
        ...
        <asp:DropDownList ID="ddTsr" runat="server">
            ...
            <asp:ListItem Value="3">ปีต่อ</asp:ListItem>
            <asp:ListItem Value="13">Train</asp:ListItem>
        </asp:DropDownList>
