<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Page/Index/MasterPage.master" AutoEventWireup="false" CodeFile="frmCovernote.aspx.vb" Inherits="Modules_Manager_Report_frmConvernote" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script language="javascript" type="text/javascript">
    function Preview(AppID, CarID, UserID) {
        var win100 = window.open('Covernote.aspx?AppID=' + AppID + '&IdCar=' + CarID + '&UserID=' + UserID, 'Preview');
        win100.focus();
        return false;
    }
</script>
 ...
 <asp:UpdatePanel ID="UpdatePanel3" runat="server" >   
    <ContentTemplate>       
       <asp:GridView runat="server" id="GVShow" AutoGenerateColumns="False" 
              DataKeyNames="AppID,IDcar"  Width="100%" AllowPaging="True" 
            BackColor="White" AutoPostBack="True">      
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:Button ID="Button1" runat="server" Text="พิมพ์"  CommandName="print" CommandArgument="<%# Container.DataItemIndex %>"/>
                    </ItemTemplate>                   
                </asp:TemplateField>
...
<asp:SqlDataSource ID="SqlLead" runat="server" 
    ...
    <asp:SqlDataSource ID="SqlSup" runat="server" 
     ...
     <asp:SqlDataSource ID="SqlNameCarID" runat="server" 
        ...
        WHERE TblApplication.Statusqc  not IN (0,3,8,9,10) and TblCar.CurStatus IN (3,4)
